...
const REFERENCES = {
    ...
    VISEME.VISEME_I: [
        ...
        [3.819456, 1.490971, 1.559814, 0.817711, 1.240422, 2.512404, 2.8416960000000002, 1.249588, 0.376978, 0.164269, 0.1208, 0.128241, 0.122829, 0.142754, 0.170965, 0.127468, 0.120068, 0.24908, 0.727598, 2.016886], 
    ], 
